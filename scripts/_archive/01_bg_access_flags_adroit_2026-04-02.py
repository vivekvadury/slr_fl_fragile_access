...
# Takes the continuous OSM road lines, cuts them at every coordinate vertex, and assigns a unique integer ID to every X/Y coordinate pair. It calculates the exact length of each segment in meters.
